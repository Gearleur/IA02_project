...
class AlphaZero:
    ...
    def learn(self, model_path=None):
        for iteration in range(self.args['num_iterations']):
            ...
            model_path = f"{model_path}/model_{iteration}.pt" or f"models/model_{iteration}.pt"
            optimizer_path = f"{model_path}/optimizer_{iteration}.pt" or f"models/optimizer_{iteration}.pt"
